...
function DayStreak({ count, weeklyDays }: DayStreakProps) {
  ...
  return (
    <div className="lg:col-span-1 col-span-3 row-span-3 bg-darker p-5 rounded-lg flex flex-col gap-3 lg:h-80">
      ...
      <h1 className="text-lg text-center mt-[-5px]">
        You beat your <span className="text-primary">personal record!</span>
      </h1>
    </div>
  );
}
